...
export function NotificationProvider({ children }: NotificationProviderProps) {
    ...
    const addNotification = useCallback((notification: Omit<Notification, 'id'>) => {
        ...
        const deduplicationKey = `${notification.type}-${notification.title}-${notification.message || ''}`;

        // Verificar si ya existe usando el ref para evitar re-renders
        const existingNotification = notificationsRef.current.find(n =>
            `${n.type}-${n.title}-${n.message || ''}` === deduplicationKey
        );
        ...
        setNotifications(prev => {
            const updatedAt = [...prev, newNotification];
    ...
    // Actualizar solo las notificaciones en el context value
    contextValue.current.notifications = notifications;
